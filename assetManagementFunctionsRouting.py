...
func_list = [printSelected, newRepair, pantsShipping, backFromApple, dropOff, makeCharger, show_charger_results_tk]
func_listTXT = "Print Selected", "New Repair", "Pants Shipping", "Back from Apple", "Drop-Off", "Make charger", "Check Charger"
