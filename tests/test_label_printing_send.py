"""Tests for label printer dispatch."""
...
def test_send_to_printer_calls_send(monkeypatch, tmp_path):
    ...
    calls = {"count": 0}
    monkeypatch.setattr(labelPrinting, "send", lambda *a, **k: calls.__setitem__("count", calls["count"] + 1))
